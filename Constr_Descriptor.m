load('./data/disease_circRNA_A.mat');
load('./data/Gaussian_Dis.mat');
load('./data/Gaussian_cricR.mat');
load('./data/disease_model1_S.mat');
load('./data/disease_model2_SS.mat');
...
for i=1:739  
    ...
    data_DCT(i,2:762)=[SD(Dis_Num,:),SC(RNA_Num,:)];
end
